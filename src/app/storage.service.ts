...
export class StorageService
{
    ...
    {
        return this.httpClient.post('https://chc-silver.ncl.ac.uk/services/storage/ws/storage/' + id, JSON.stringify(value), httpOptions)
                   .toPromise()
    ...
    {
        return this.httpClient.get('https://chc-silver.ncl.ac.uk/services/storage/ws/storage/' + id)
                   .toPromise()
                   .then((response: any) => Promise.resolve(this.storageInformationSuccessHandler(response)))
                   .catch((error) => Promise.resolve(this.storageInformationErrorHandler(error)));
    }
    ...
    {
        return this.httpClient.put('https://chc-silver.ncl.ac.uk/services/storage/ws/storage/' + id, JSON.stringify(value), httpOptions)
                   .toPromise()
                   .then((response: any) => Promise.resolve(this.storageInformationSuccessHandler(response)))
                   .catch((error) => Promise.resolve(this.storageInformationErrorHandler(error)));
    }
    ...
    {
        return this.httpClient.delete('https://chc-silver.ncl.ac.uk/services/storage/ws/storage/' + id)
                   .toPromise()
                   .then((response: any) => Promise.resolve(this.storageInformationSuccessHandler(response)))
                   .catch((error) => Promise.resolve(this.storageInformationErrorHandler(error)));
    }
